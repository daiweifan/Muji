  ...
  <body>
            ...
            <div class="col-md-12">
              <div class="content-panel">
                <table class="table table-striped table-advance table-hover">
                  <h4><i class="fa fa-angle-right"></i> <a href="/backend/author/form" class="btn btn-round btn-primary">新增设计师</a></h4>
                  <hr>
                  <thead>
                    <tr>
                      <th width="10%"><i class="fa fa-user"></i> 姓名</th>
                       <th width="15%"><i class="fa fa-avatar"></i>头像</th>
                      <th width="45%" class="hidden-phone"><i class="fa fa-question-circle"></i> 简介</th>
                      <th width="10%"><i class="fa fa-bookmark"></i>微信号</th>
                      <th width="10%"><i class=" fa fa-edit"></i> 类型</th>
                      <th width="10%">操作</th>
                    </tr>
                  </thead>
                  <tbody>
                  <#if authors?? && (authors?size > 0)>
	                  <#list authors as author>
	                    <tr>
	                      <td >${author.name!}</td>
	                      <td><img src="${author.avatar!}" class="profile img-circle" width="60" height="60"></td>
	                      <td class="hidden-phone">${author.description!}</td>
	                      <td>${author.wechat!} </td>
	                      ...
	                      <td>
	                        <a href="/backend/author/form?id=${author.id}" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
	                        <a data-href="/backend/author/delete" class="btn btn-danger btn-xs a_post" data-id="${author.id}"><i class="fa fa-trash-o "></i></a>
	                      </td>
	                    </tr>
	                   </#list>
                    </#if>
    ...
    <script type="text/javascript">  
	 	$(function(){
			...
			var listUrl  = "/backend/author/list";
