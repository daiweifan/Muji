...
<html lang="en">
  <head>
    ...
    <meta name="carousel" content="Dashboard">
  ...
  <body>
        ...
        <div id="sidebar"  class="nav-collapse ">
          <ul class="sidebar-menu">
            ...
            <li class="sub-menu">
             ...
             <li class="sub-menu">
              <a  class="active" href="/backend/carousel/list" >
                <i class="fa fa-th"></i>
                <span>首页轮播图</span>
              </a>
            </li> 
     ...
     <!-- 主要内容-->
      ...
      <section id="main-content">
        <section class="wrapper">
          <h3><i class="fa fa-angle-right"></i> 首页轮播图信息</h3>
          <hr>
          ...
          <div class="row mt">
            <div class="col-lg-12">
              <div class="form-panel">
                ...
                <form class="form-horizontal style-form" id="carousel_form">
                 <div class="form-group">
                    <label class="col-sm-2 col-sm-2 control-label">排序号</label>
                    <div class="col-sm-10" >
						<input type="number" class="form-control" name="orderNum" value="<#if carousel??>${carousel.orderNum!}</#if>">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 col-sm-2 control-label">大标题</label>
                    <div class="col-sm-10" >
						<input type="text" class="form-control" name="title" value="<#if carousel??>${carousel.title!}</#if>">
                      <input type="hidden" class="form-control" name="id" value="<#if carousel??>${carousel.id!}</#if>" >
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <textarea class="form-control round-form" name="description" ><#if carousel??>${carousel.description!}</#if></textarea>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      ...
                      <input type="hidden" id="avatar"  name="image" value="<#if carousel??>${carousel.image!}</#if>">
                    	<img id="image_show"  style="width:600px;height:400px;" src="<#if carousel??>${carousel.image!}</#if>" class="image-responsive"/>
                    </div>
                  </div>
                  <div class="form-group center">
                  	<div class="col-sm-offset-2 col-sm-10">
                  		<button type="button" class="btn btn-round btn-primary" id="save_carousel">保存</button>
                  		<a href="/backend/carousel/list" type="button" class="btn btn-round btn-default" >返回</a>
                  	</div>
                  </div>
                </form>
              </div>
    ...
    <script type="text/javascript">  
	 	$(function(){
			...
			var savecarouselUrl = "/backend/carousel/update";
			
			var carouselListUrl = "/backend/carousel/list";
			...
			$("#save_carousel").click(function(){
				if($("#avatar").val()){
					var formData = $("#carousel_form").serialize();
					$.ajax({
							url:savecarouselUrl,
							method:"post",
							data:formData,
							success:function(data){
								if(data.success){
									...
									window.location.href=carouselListUrl;
								}
							}
						})
				}else{
