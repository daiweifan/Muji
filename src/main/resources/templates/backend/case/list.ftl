     ...
     <!-- 主要内容-->
      ...
      <section id="main-content">
        <section class="wrapper">
          <h3><i class="fa fa-angle-right"></i> 案例列表</h3>
          <hr>
            ...
            <div class="col-md-12">
              <div class="content-panel">
                <table class="table table-striped table-advance table-hover">
                  <h4><i class="fa fa-angle-right"></i> <a href="/backend/case/form" class="btn btn-round btn-primary">新增案例</a></h4>
                  <hr>
                  <thead>
                    <tr>
                      <th width="10%"><i class="fa fa-user"></i> 案例名称</th>
                      <th width="12%"><i class="fa fa-image"></i>封面图片</th>
                      <th width="55%" class="hidden-phone"><i class="fa fa-question-circle"></i> 简介</th>
                      <th width="8%"><i class="fa fa-bookmark"></i>案例时间</th>
                      <th width="15%">操作</th>
                    </tr>
                  </thead>
                  <tbody>
                  <#if cases?? && (cases?size > 0)>
	                  <#list cases as case>
	                    <tr>
	                      <td >${case.name!}</td>
	                      <td align="center"><img src="${case.coverImage!}" class="profile img-responsive" width="60" height="60"></td>
	                      <td class="hidden-phone">${case.description!}</td>
	                      <td>${case.createTime!} </td>
	                      <td>
	                        <a href="/backend/case/form?id=${case.id}" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
	                        <a data-href="/backend/case/delete" class="btn btn-danger btn-xs a_post" data-id="${case.id}"><i class="fa fa-trash-o "></i></a>
	                      </td>
	                    </tr>
	                   </#list>
                    </#if>
