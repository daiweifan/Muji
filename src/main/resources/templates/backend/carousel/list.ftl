  ...
  <body>
     ...
     <!-- 主要内容-->
      ...
      <section id="main-content">
        <section class="wrapper">
          <h3><i class="fa fa-angle-right"></i> 首页轮播图列表</h3>
          <hr>
            ...
            <div class="col-md-12">
              <div class="content-panel">
                <table class="table table-striped table-advance table-hover">
                  ...
                  <thead>
                    <tr>
                      <th><i class="fa fa-no"></i>排序号</th>
                       <th><i class="fa fa-info"></i>大标题</th>                   
                       <th><i class="fa fa-image"></i>图片</th>
                       <th><i class="fa fa-user"></i>简介</th>
                      <th>操作</th>
                    </tr>
                  </thead>
                  <tbody>
                  <#if carousels?? && (carousels?size > 0)>
	                  <#list carousels as carousel>
	                    <tr>
	                      <td >${carousel.orderNum!}</td>
	                      <td >${carousel.title!}</td>
	                      <td>
	                      	<#if carousel.image??>
	                      		<img src="${carousel.image!}" class="profile img-responsive" width="60" height="60">
	                      	<#else>
	                      ...
	                      <td>
	                        <a href="/backend/carousel/form?id=${carousel.id}" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
	                      </td>
	                    </tr>
	                   </#list>
                    </#if>
    ...
    <script type="text/javascript">  
	 	$(function(){
			...
			var listUrl  = "/backend/carousel/list";
